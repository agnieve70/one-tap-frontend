  ...
  return (
    <header className={styles.header}>
      <div className={styles.header__logo_box}>
        <img className={styles.header__logo} src="./logo_white.png" alt="logo" />
      </div>
      <div className={styles.header__text_box}>
        <h1 className={styles.heading_primary}>
          <span className={styles.heading_primary__main}>ONE TAP</span>
          <span className={styles.heading_primary__sub}>Always ready to help</span>
        </h1>
        <Link
          to="/login"
